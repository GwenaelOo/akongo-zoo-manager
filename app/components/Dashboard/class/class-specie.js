export class specie {
    constructor(name, createByZoo, profilePicturUrl, maxAge, origin, originPictUrl, description, pictList, amount, enclosure) {
        // Name of the species - String
        this._specieName = name;

        // Name of the species - String
        this.createByZoo = createByZoo;
    ...
    // Handle NAMES
    getCreateByZoo() {
        return this._CreateByZoo;
    }

    setCreateByZoo(newSpecieName) {
        this._CreateByZoo = CreateByZoo;
    }
